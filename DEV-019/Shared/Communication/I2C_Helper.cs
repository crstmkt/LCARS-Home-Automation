...
//Not shure if this file is needed here or in LCARSHomeAutomation.Core.Communication...
    ...
    public class I2C_Helper
    {
        ...
        public static async System.Threading.Tasks.Task<byte[]> WriteRead(Room _Room, Mode ControlMode, byte Pin = 0, byte PinValue = 0)
        {
            ...
            try
            {
                ...
                {
                    byte[] temp = new byte[] { byte.Parse(ControlMode.ToString().Replace("Mode", "")), Pin, PinValue };
