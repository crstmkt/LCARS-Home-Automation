...
namespace Shared.Classes
{
    ...
    public class Home
    {
        ...
        //<summary>
        //Gets or setzt Latitude
        //</summary>
        [DataMember]
        public BasicGeoposition Geofence;// { get; set; }

        // <summary>
        // Get or set last update
        // </summary>
        [DataMember]
        ...
        public Home()
        {
            ...
            Geofence.Latitude = 51.607009;
            Geofence.Longitude = 7.367514;
            Geofence.Altitude = 0.0;
        ...
        public static async void SaveHome(Home MyHome)
        {
            ...
            MyHome.LastUpdate = DateTime.Now;
            MyHome.Geofence.Latitude = 51.607009;
            MyHome.Geofence.Longitude = 7.367514;
            MyHome.Geofence.Altitude = 0.0;
